...
#include "./plugins/clock/clocklabel.h"
#include "./plugins/mainmenu/mainmenu.h"
#include "./plugins/systray/systray.h"
#include "./plugins/taskbar/qmtaskbar.h"
...
MainPanel::MainPanel(Resources & res) : mLayout(this)
{
    ...
    mLayout.addWidget(new QMTaskBar(res, this));
